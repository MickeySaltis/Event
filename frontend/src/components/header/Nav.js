                    ...
                    <div className="max-w-screen-xl px-4 py-3 mx-auto md:px-6">
                        <div className="flex items-center">
                            <ul className="flex flex-row mt-0 mr-6 space-x-8 text-sm font-medium">
                                ...
                                <li>
                                    <a href="/evenementdujour" className="dark:text-white hover:font-bold hover:underline">Evénements du jour</a>
                                </li>
                                <li>
                                    <a href="/categories" className="dark:text-white hover:font-bold hover:underline">Catégories</a>
                                </li>
